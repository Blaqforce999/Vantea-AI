    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            'h-48 w-full rounded-xl border bg-surface px-16 pr-40 text-body-regular text-on-surface placeholder:text-on-surface-variant focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary',
            borderColor,
            className,
          )}
          {...props}
