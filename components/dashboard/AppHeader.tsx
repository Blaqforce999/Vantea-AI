...
export async function AppHeader() {
  ...
  return (
    <header className="border-b border-outline-variant bg-surface">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-24 py-12 min-[760px]:py-16">
        <Link href="/dashboard" aria-label="Vantea home" className="flex items-center">
          <picture>
            ...
            <img src="/vantea-logo-desktop.svg" alt="Vantea AI" className="h-24 w-auto min-[760px]:h-28" />
          </picture>
        </Link>
